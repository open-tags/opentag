...
/**
 * Method to notify the client from the peripheral
*/
...
/**
 * Method to send the iPhone acknowledgement of 
 * receiving of Shared Configuration data
*/
...
/**
 * This is the callback method passed onto the TX Characteristic 
*/
...
//**************************************************************************************************************
// NIQ Middleware Related Methods
//*******************************************************************************************************
...
/**
 * Method to generate and send accesory config data
 * Designed as per structure defined in the
 * Nearby Interaction Accessory Protocol Specification - Release 2
*/
static void send_accessory_config_data() {
    niq_reinit();
...
/**
 * Method to print out the buffer contents in binary
*/
...
/**
 * Method to print our value in binary
*/
...
/**
 * Method to debug an niq packet and its content
*/

void debug(ni_packet_t * packet){
...
void spi_rd_err_cb(){
  Serial.print("SPI Read error Call Back");
}
...
void setup() {
  ...
  Serial.println("Awaiting for Connection");
}

void loop() {
  while (!start_uwb){}
  //start_TWR(); --> To be implemented
}